...
class GetTweetsYearprogress(BaseGetTweetsScenario):
    ...
    # Some expected tweets are commented because are not fetched on Search due to some bug with nitter
    expected_tweets = [
        # TwitterTweet(tweet_id=1540560429335908353, author='year_progress', created_on=datetime.datetime(2022, 6, 25, 5, 0, tzinfo=datetime.timezone.utc), text='▓▓▓▓▓▓▓░░░░░░░░ 48%', stats=TwitterTweet.Stats(comments=40, retweets=1216, quotes=115, likes=8141)),
